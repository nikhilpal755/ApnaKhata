...
export default function({name, email, phone, address,dueDate, date , id, notes, subTotal, total, type, vat , items,
status, totalAmountReceived, balanceDue, company}){
    ...
    return (
        ...
        <section class="address">
              ...
              <div>
                  ...
                  <h4 style="font-size: 9px; line-height: 5px">${company?.businessName ? company.businessName : "Apnakhata"}</h4>
