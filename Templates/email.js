          ...
          invoice-link {
            ...
            <body>
                ...
                <div class="content">
                    ...
                    <h1 class="name">${company?.businessName ? company?.businessName : "Apnakhata"}</h1>
                    
                      <hr>
                      <div>
                          <p style="font-size: 18px">${Number(balanceDue) <= 0 ? 'Thank you for your business' : type} ${Number(balanceDue) != 0 ? 'for' : ''} <span style="font-weight: 700">${Number(balanceDue) <= 0 ? '' : balanceDue}</span> ${Number(balanceDue) <= 0 ? '' : `due by`} <span style="font-weight: 700">${Number(balanceDue) <= 0 ? '' : dueDate}</span></p>
                      </div>
